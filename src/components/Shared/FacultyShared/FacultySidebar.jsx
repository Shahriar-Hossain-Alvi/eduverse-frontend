...
const FacultySidebar = () => {
  return (
    <aside>
      ...
      <div className="drawer fixed top-3 left-1 lg:hidden z-50 text-white w-10">
        ...
        <div className="drawer-side">
          ...
          <ul id="facultySideBar" className="space-y-4 text-sm text-center md:text-base menu min-h-full w-80 p-4 bg-green-700 text-white">
            <li><NavLink to="/faculty/dashboard" className="flex items-center space-x-2 hover:bg-green-600 p-2 rounded"><GrOverview className="text-xl" /> <span>Overview</span></NavLink></li>
