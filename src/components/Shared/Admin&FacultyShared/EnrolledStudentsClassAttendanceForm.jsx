...
const EnrolledStudentsClassAttendanceForm = ({ course_id, class_id }) => {
    ...
    const { data: studentsAttendanceRecord = {}, isPending, isError, error } = useQuery({
        queryKey: [],
        queryFn: async () => {
    ...
    // console.log(studentListForAttendance);
                    ...
                    {studentListForAttendance.map(singleStudent => <div key={singleStudent._id} className="border p-2 grid grid-cols-3 gap-2 items-center">
                        ...
                        <label className="form-control w-full max-w-xs">
                            ...
                            <div>
                                ...
                                {errors.attendanceRemarks && <p className="text-error text-sm  pl-3 pt-1 animate-pulse">{errors.attendanceRemarks.message}</p>}
                            </div>
                        </label>
                    </div>)}
